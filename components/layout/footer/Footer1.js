			...
			<footer id="footer" className="relative footer-style-2">
				...
				<div className="tf-container relative z-index-3">
					...
					<div className="row">
						...
						<div className="col-sm-12 col-lg-6" style={{padding:"16px"}}>
							<a href="https://www.facebook.com/veotronic/"><i className="icon-fb" style={{display: "inline-block", width: "50px", height: "50px", borderRadius: "50%", border: "5px solid #fff", textAlign: "center", lineHeight: "40px", backgroundColor: "#086AD8", color: "#fff"}} /> <span  style={{color: "#086AD8", fontWeight: "bold"}}>Facebook</span></a>
						</div>
