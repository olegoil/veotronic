...
export default function CanDoIt1() {
	return (
		<>
					...
					<div className="row">
						<div className="col-md-6">
							<div className="can-do-it-image relative">
								<div className="elip" />
								<img src="/assets/images/page/image-feature-h41.jpg" alt="image" className="cdit-image" />
								<img src="/assets/images/page/image-feature-h42.jpg" alt="image" className="cdit-image1" />
								<div className="quote-feature-wrap">
									<div className="counter tf-counter">
										<div className="number number-style" data-speed={2000} data-to={25} data-inviewport="yes"><CounterNumber count={25} /></div>
									</div>
						...
						<div className="col-md-6">
							<div className="can-do-it-content">
								...
								<p className="cdit-text mb-40">We approached Veotronic complex project Designing website
								...
								<div className="flex icon-wrap-cdit">
									<div className="icon-can-do-it flex">
										...
										<h5 className="title">Organizations and recognized work</h5>
									</div>
									<div className="icon-can-do-it flex">
										<div className="icon">
											<i className="icon-nanotechnology" />
										</div>
										<h5 className="title">We Use latest tech to run your project</h5>
									</div>
								</div>
